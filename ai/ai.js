        ...
        if (userMessage !== "") {
            ...
            let botResponse;
                if (userMessage.toLowerCase().includes("ciao")) {
                    ...
                    botResponse = "Per aggiungere una domanda ad Enricozon AI ti basta inviare un'email all'email support@anozon.it; la tua domanda sarà visualizzata dai developper di Enricozon e se rispetta i criteri verrà aggiunta ad Enricozon AI. Ti sarà inviata un'email di risposta se la tua domanda sarà aggiunta!";
                }
